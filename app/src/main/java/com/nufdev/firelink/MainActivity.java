...
import com.nufdev.firelink.fragment.NotificationsFragment;
import com.nufdev.firelink.fragment.SettingsFragment;
import com.nufdev.firelink.objects.User;
import com.nufdev.firelink.other.CircleTransform;
...
public class MainActivity extends AppCompatActivity implements //:
    ...
    private static String urlProfileImg = "https://lh3.googleusercontent.com/-z4Pd0pkkE3w/AAAAAAAAAAI/AAAAAAAAAJ8/N85vrjLHh0Q/s96-c/photo.jpg";
    ...
    private void loadNavHeader() {
        // name, website
        txtName.setText(firelinkUser.getDisplayName());
        txtWebsite.setText(firelinkUser.getEmail());
        ...
        Glide.with(this).load(firelinkUser.getPhotoUrl())
                .crossFade()
                .thumbnail(0.5f)
